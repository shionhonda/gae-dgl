...
from torch_geometric.nn import GroupAddRev, Aggregation, GAE
...
def create_graph_autoencoder(encoder: torch.nn.Module, decoder=Optional[torch.nn.Module]) -> GAE:
    gae = GAE(encoder=encoder, decoder=decoder)
    return gae
